...
def input_command(command):
    ...
    elif "initialize object recognition" in command:
        output("Initializing object recognition...")
...
output("Initializing recognition...")
...
while True:
    ...
    if result:
        ...
        output("Recognition failed, please try again")
grettings()
